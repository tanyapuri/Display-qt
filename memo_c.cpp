    ...
    date_num(date)
{
    ...
    if(type==0) ui->textBrowser_type->setText(tr("daily"));
    if(type==1) ui->textBrowser_type->setText(tr("learn"));
    if(type==2) ui->textBrowser_type->setText(tr("entertainment"));
    if(type==3) ui->textBrowser_type->setText(tr("other"));
}
...
{
    int ans=QMessageBox::question(this,"warning",tr("Are you sure you want to delete this record\0"),QMessageBox::Yes,QMessageBox::No);
